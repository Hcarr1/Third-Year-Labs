...
def ReLU_derivative(v) -> float:
    """
    function to apply derivative of rectified Linear Unit (ReLU) activation function
    :param v:
    :return: float
    """
    if v <= 0:
...
def Sigmoid_derivative(v) -> float:
    """
    function to apply derivative of sigmoid activation function
    :param v:
    :return: float
    """
    sig = Sigmoid(v)
...
def Tanh_derivative(v) -> float:
    """
    function to apply derivative of tanh activation function
    :param v:
    :return: float
    """
...
def SiLU_derivative(v) -> float:
    """
    function to apply derivative of Sigmoid Linear Unit (SiLU) activation function
    :param v:
    :return: float
    """
    sig = Sigmoid(v)
